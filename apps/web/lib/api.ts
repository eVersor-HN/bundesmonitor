...
// Standard-Timeout fuer alle Netz-Abrufe (mobil kann ein Abruf sonst ewig
// haengen und die UI blockieren).
export const FETCH_TIMEOUT_MS = 10_000;

// fetch mit hartem Timeout ueber einen AbortController. Bricht der Abruf ab,
// propagiert die Rejection normal weiter, sodass die withCache-/Fallback-Logik
// greift (Cache/null) statt haengen zu bleiben. Der Timer wird immer geraeumt.
