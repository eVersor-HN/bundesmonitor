...
export function GeldHubTiles() {
  ...
  useEffect(() => {
    ...
    if (reduce) return;
    // Nur ticken, wenn der Tab sichtbar ist – im Hintergrund spart das CPU/Akku.
  ...
  return (
    <section className="bm-tilegrid" aria-label="Schulden und Haushalt">
      <Link href="/geld/schulden" className="bm-tile bm-tile--hero bm-tile--span2">
        ...
        <span className="bm-tile__big" style={{ fontSize: "clamp(1.2rem, 3.4vw + 0.55rem, 1.9rem)", margin: "0.2rem 0" }}>
